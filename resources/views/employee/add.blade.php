...
<div class="container py-4">
    ...
    <div class="text-center mb-4">
        <h2 class="fw-semibold text-dark">Add New Employee</h2>
        <p class="text-muted small">Please fill in the form to continue</p>
    </div>
                    ...
                    <form method="POST" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="middle_name" class="form-control" placeholder="Middle Name (optional)" value="{{ old('middle_name') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-2">
                                <div class="col-md-9">
                                    <textarea name="address" class="form-control" rows="2" placeholder="Full Address" required>{{ old('address') }}</textarea>
                                </div>
                                <div class="col-md-3">
                                    <input type="number" name="salary" class="form-control" placeholder="Salary" value="{{ old('salary') }}" required>
                                </div>
                            </div>
                        </div>
